package com.skoow.rhino.mod.wrapper;

import com.skoow.rhino.mod.util.color.Color;
import com.skoow.rhino.mod.util.color.NoColor;
import com.skoow.rhino.mod.util.color.SimpleColor;
import com.skoow.rhino.mod.util.color.SimpleColorWithAlpha;
