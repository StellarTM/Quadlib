 ...
 * Java classes by the classes from the {@link com.skoow.snakeyaml.constructor} package.
 * </p>
 */
public abstract class Node {

  private com.skoow.snakeyaml.nodes.Tag tag;
  ...
  public Node(com.skoow.snakeyaml.nodes.Tag tag, Mark startMark, Mark endMark) {
    setTag(tag);
   ...
   */
  public com.skoow.snakeyaml.nodes.Tag getTag() {
    return this.tag;
  }
  ...
  public void setTag(com.skoow.snakeyaml.nodes.Tag tag) {
    if (tag == null) {
