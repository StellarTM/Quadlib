 ...
 * the License.
 */
package com.skoow.snakeyaml.extensions.compactnotation;
...
import com.skoow.snakeyaml.extensions.compactnotation.CompactData;
...
public class CompactConstructor extends Constructor {
  ...
  protected Object constructCompactFormat(ScalarNode node, com.skoow.snakeyaml.extensions.compactnotation.CompactData data) {
    try {
  ...
  protected Object createInstance(ScalarNode node, com.skoow.snakeyaml.extensions.compactnotation.CompactData data) throws Exception {
  ...
  public com.skoow.snakeyaml.extensions.compactnotation.CompactData getCompactData(String scalar) {
    if (!scalar.endsWith(")")) {
      return null;
    }
    if (scalar.indexOf('(') < 0) {
    ...
    if (m.matches()) {
      ...
      com.skoow.snakeyaml.extensions.compactnotation.CompactData data = new com.skoow.snakeyaml.extensions.compactnotation.CompactData(tag);
      if (content.isEmpty()) {
        return data;
      }
