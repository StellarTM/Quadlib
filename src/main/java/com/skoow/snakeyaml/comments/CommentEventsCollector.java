 ...
 * the License.
 */
package com.skoow.snakeyaml.comments;
...
public class CommentEventsCollector {
  ...
  private final com.skoow.snakeyaml.comments.CommentType[] expectedCommentTypes;
   ...
   *        collected.
   */
  public CommentEventsCollector(final Parser parser, com.skoow.snakeyaml.comments.CommentType... expectedCommentTypes) {
   ...
   *        collected.
   */
  public CommentEventsCollector(Queue<Event> eventSource, com.skoow.snakeyaml.comments.CommentType... expectedCommentTypes) {
